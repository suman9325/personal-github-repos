...
class App extends Component {
  ...
  onFormSubmit(data) {
    ...
    if(this.state.isEditProduct){
      apiUrl = 'http://localhost/suman_php/CI_React_API/index.php/ReactApi/editProduct';
    } else {
      apiUrl = 'http://localhost/suman_php/CI_React_API/index.php/ReactApi/createProduct';
    }
  ...
  editProduct = productId => {
    ...
    const apiUrl = 'http://localhost/suman_php/CI_React_API/index.php/ReactApi/getProduct';
