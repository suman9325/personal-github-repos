        ...
        <>
            <div className="detail-padding">
                <table className="table" >
                    <thead className="MemberTabtable-1-head" data-testid="MemberTabtableHead1">
                    ...
                    <tbody className="MemberTabtable-1-body" data-testid="MemberTabtableBody1">
                        <tr>
                ...
                <br />
                <table className="table">
                    <thead className="MemberTabtable-2-head" data-testid="MemberTabtableHead2">
                        <tr className="card-heading">
                    ...
                    <tbody className="MemberTabtable-2-body" data-testid="MemberTabtableBody2">
                        <tr>
