        ...
        <>
            <div className="detail-padding">
                <table className="table" >
                    <thead className="ProductTabtable-1-head" data-testid="ProductTabtableHead1">
                    ...
                    <tbody className="ProductTabtable-1-body" data-testid="ProductTabtableBody1">
                        <tr>
                ...
                <br />
                <table  className="table">
                    <thead className="ProductTabtable-2-head" data-testid="ProductTabtableHead2"> 
                        <tr className="card-heading">
