...
const Transactionbox = (props) => {
    ...
    useEffect(() => {
        ...
        //     .then(res => {
        //         setClaimList(!!res.data ? res.data : [])
    ...
    const rowSelect = (row) => {
        console.log('row', row);
        setCheckedRows(row.selectedRows)
                            ...
                            {/* <Card elevation={4}>
                                <CardContent>
                                    <Paper square>
                                        ...
                                        >
                                            {checkedRows.map((rows) => (
                                                <Tab label={"Sequence" + rows.id} onClick={() => {
                                                    setFilterRowId(checkedRows.filter(item => item.id == rows.id))
                                                }} />
                                            ))
                                            }
                                        </Tabs>
                                        {console.log('filter', filterRowId)}
