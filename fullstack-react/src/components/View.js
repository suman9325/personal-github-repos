...
class ViewForm extends React.Component {
    ...
    componentDidMount() {
        ...
        // this.state.userdata.filter(item=> {item.id != '10' || item.id != 10})
    }
    ...
    ViewUserByID = (e) => {
        ...
        axios.post(API+'getDataByID', JSON.stringify({
                        ...
                        <tbody>
                            {this.state.userdata.map((item) => (
                                <tr>
                                    ...
                                    <td colSpan="2">
                                        <button className="btn btn-success" onClick={()=>this.editUser(item.id)}>Edit</button>
